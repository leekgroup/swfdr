# This version of lm_pi0 is one from package version 1.2.1
# The main code is untouched compared to v1.2.1, except for:
#  - the function name has a version suffix
#  - the function comment no longer marks the function for export 

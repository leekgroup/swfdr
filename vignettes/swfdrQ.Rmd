...
```{r, eval=TRUE, fig.width=2.5, fig.height=2.5}
hist(D2_lm_pi0, cssclass="ps8")
```
...
```{r D2_lm_q_plot, echo=FALSE, eval=TRUE, fig.width=5.0, fig.height=2.5}
oldpar = par()
par(mfrow=c(1,2))
plot(D2_lm_q, var.x="p", cssclass="ps8")
plot(D2_lm_q, var.x="q", cssclass="ps8")
...
```{r D2_noisy_plot, echo=FALSE, eval=TRUE, fig.width=7.5, fig.height=2.5}
oldpar = par()
par(mfrow=c(1,3))
hist(D2_noisy_lm_q, cssclass="ps8")
plot(D2_noisy_lm_q, var.x="p", cssclass="ps8")
plot(D2_noisy_lm_q, var.x="q", cssclass="ps8")
par(mfrow=oldpar$mfrow)
```

...
Both visualizations resemble clouds. The dashed lines, set at 0.05 by default, provide visual guides to separate points below the threshold. The plot on the right, in particular, reveals that modeling detects significant hits when none were called with unconditioned q-values.
